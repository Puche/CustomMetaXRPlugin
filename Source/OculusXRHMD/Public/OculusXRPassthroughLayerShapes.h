...
public:
	...
	FReconstructedLayer(){};
	FReconstructedLayer(const FEdgeStyleParameters& EdgeStyleParameters, const EOculusXRPassthroughLayerOrder PassthroughLayerOrder)
...
//ENGINE_API const FName FReconstructedLayer::ShapeName = FName("OculusReconstructedLayer");
